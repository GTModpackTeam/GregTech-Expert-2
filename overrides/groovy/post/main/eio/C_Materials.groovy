...
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        ...
        [metaitem('plateIron'), item('enderio:item_material', 20), metaitem('plateIron')],
        [ore('barsIron'), metaitem('plateIron'), ore('barsIron')],
    ])
    .register()
...
// Conduit Binder
electricBlastFurnace.recipeBuilder()
    .inputs(
        metaitem('dustClay') * 3,
...
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        ...
        [null, metaitem('stickDarkSteel'), item('minecraft:leather')],
        [metaitem('stickDarkSteel'), item('minecraft:leather'), item('minecraft:leather')],
    ])
    .register()
...
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        ...
        [item('enderio:item_material', 6), metaitem('stickLongDarkSteel'), item('enderio:item_material', 6)],
    ])
    .register()
...
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        [item('minecraft:dye', 15), metaitem('plateElectricalSteel'), null],
        [null, item('minecraft:dye', 15), metaitem('plateElectricalSteel')],
        [item('minecraft:dye', 15), metaitem('plateElectricalSteel'), null],
    ])
    .register()
