...
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        ...
        [item('minecraft:stick'), metaitem('stickStone'), metaitem('stickStone')],
...
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        [null, ore('craftingToolHardHammer'), null],
        [item('minecraft:stick'), metaitem('stickStone'), metaitem('stickStone')],
        [item('minecraft:stick'), metaitem('plateIron'), metaitem('plateIron')],
    ])
    .register()
...
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        [null, ore('craftingToolHardHammer'), null],
        [item('minecraft:stick'), metaitem('stickStone'), metaitem('stickStone')],
        [item('minecraft:stick'), metaitem('plateDiamond'), metaitem('plateDiamond')],
    ])
    .register()
