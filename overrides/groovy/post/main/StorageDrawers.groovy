...
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        [item('minecraft:stick'), metaitem('frameWood'), item('minecraft:stick')],
...
assembler.recipeBuilder()
    .circuitMeta(11)
    .inputs(metaitem('frameWood') * 5, item('minecraft:stick') * 4)
...
assembler.recipeBuilder()
    .circuitMeta(11)
    .inputs(metaitem('frameTreatedWood') * 5, metaitem('stickTreatedWood') * 4)
...
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        [metaitem('frameWood'), metaitem('frameWood'), metaitem('frameWood')],
        [metaitem('frameWood'), item('minecraft:chest'), metaitem('frameWood')],
        [metaitem('frameWood'), metaitem('frameWood'), metaitem('frameWood')],
    ])
    .register()
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        [metaitem('frameTreatedWood'), metaitem('frameTreatedWood'), metaitem('frameTreatedWood')],
        [metaitem('frameTreatedWood'), item('minecraft:chest'), metaitem('frameTreatedWood')],
        [metaitem('frameTreatedWood'), metaitem('frameTreatedWood'), metaitem('frameTreatedWood')],
    ])
    .register()
assembler.recipeBuilder()
    .circuitMeta(12)
    .inputs(metaitem('frameWood') * 8, item('minecraft:chest'))
...
assembler.recipeBuilder()
    .circuitMeta(12)
    .inputs(metaitem('frameTreatedWood') * 8, item('minecraft:chest'))
...
assembler.recipeBuilder()
    .circuitMeta(13)
    .inputs(metaitem('frameWood') * 7, item('minecraft:chest') * 2)
...
assembler.recipeBuilder()
    .circuitMeta(13)
    .inputs(metaitem('frameTreatedWood') * 7, item('minecraft:chest') * 2)
...
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        [item('minecraft:chest'), metaitem('frameWood'), item('minecraft:chest')],
        [metaitem('frameWood'), metaitem('frameWood'), metaitem('frameWood')],
        [item('minecraft:chest'), metaitem('frameWood'), item('minecraft:chest')],
    ])
    .register()
mods.minecraft.crafting.shapedBuilder()
    ...
    .shape([
        [item('minecraft:chest'), metaitem('frameTreatedWood'), item('minecraft:chest')],
        [metaitem('frameTreatedWood'), metaitem('frameTreatedWood'), metaitem('frameTreatedWood')],
        [item('minecraft:chest'), metaitem('frameTreatedWood'), item('minecraft:chest')],
    ])
    .register()
assembler.recipeBuilder()
    .circuitMeta(14)
    .inputs(metaitem('frameWood') * 5, item('minecraft:chest') * 4)
...
assembler.recipeBuilder()
    .circuitMeta(14)
    .inputs(metaitem('frameTreatedWood') * 5, item('minecraft:chest') * 4)
...
assembler.recipeBuilder()
    .circuitMeta(8)
    .inputs(metaitem('screwIron') * 4, ore('drawerBasic'))
...
assembler.recipeBuilder()
    .circuitMeta(8)
    .inputs(metaitem('screwSteel') * 4, ore('drawerBasic'))
