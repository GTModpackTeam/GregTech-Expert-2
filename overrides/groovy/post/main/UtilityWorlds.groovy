...
assembler.recipeBuilder()
    .circuitMeta(1)
    .inputs(metaitem('frameAluminium'), metaitem('plateRedstone'), metaitem('plateObsidian') * 3)
...
assembler.recipeBuilder()
    .circuitMeta(1)
    .inputs(metaitem('frameTitanium'), metaitem('plateEmerald'), metaitem('plateObsidian') * 3)
