...
electromagnetic_separator.recipeBuilder()
    ...
    .chancedOutput(<metaitem:dustAdamantite>, 3000, 0)
...
assembly_line.recipeBuilder()
    ...
    .inputs([<enderio:block_fused_glass>])
...
assembly_line.recipeBuilder()
    ...
    .inputs([<metaitem:plate.high_power_integrated_circuit> * 4])
...
assembly_line.recipeBuilder()
    ...
    .inputs([<metaitem:plate.ultra_high_power_integrated_circuit> * 4])
